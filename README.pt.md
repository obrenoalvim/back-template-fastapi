...
1. **build** — `uv sync`, `ruff check`, `ruff format --check`, `mypy`, `alembic upgrade head`, `pytest` — tudo contra um container de serviço Postgres real
